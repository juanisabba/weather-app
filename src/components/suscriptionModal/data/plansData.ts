...
export const basicPlan: ISuscriptionPlan[] = [
  ...
  { id: 2, name: "Data histórica", included: false },
  { id: 2, name: "En múltiples idiomas", included: false },
];
...
export const premiumPlan: ISuscriptionPlan[] = [
  ...
  { id: 1, name: "Pronóstico semanal", included: true },
  { id: 2, name: "Pronóstico mensual", included: true },
  { id: 2, name: "Data histórica", included: true },
  { id: 2, name: "En múltiples idiomas", included: true },
];
